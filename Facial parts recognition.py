...
face_cascade = cv2.CascadeClassifier('D:\FaceDetection\haarcascade_frontalface_alt.xml')
eye_cascade = cv2.CascadeClassifier('D:\work\Datasets\haarcascade_eye.xml')
lips_cascade = cv2.CascadeClassifier('D:\work\Datasets\haarcascade_smile.xml')
